...
object AutoConstants {
  ...
  @JvmField val kDriveBaseRadiusMeters: Double = SwerveConstants.driveBaseRadius
  const val kPathGenerationEndGoalVelocity: Double = 0.0
  const val kPathGenerationRotationalDelay: Double =
  ...
  @JvmField val kRedSpeakerLocation: Pose2d = Pose2d(15.26, 5.56, Rotation2d.fromDegrees(-180.0))

  @JvmField val kBlueSpeakerLocation: Pose2d = Pose2d(1.27, 5.56, Rotation2d.fromDegrees(180.0))

  @JvmField val kRedAmpLocation: Pose2d = Pose2d(14.74, 7.48, Rotation2d.fromDegrees(90.0))

  @JvmField val kBlueAmpLocation: Pose2d = Pose2d(1.81, 7.57, Rotation2d.fromDegrees(90.0))
