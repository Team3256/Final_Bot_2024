...
object PivotShooterConstants {
    ...
    const val kWingNoteSidePreset: Double = 5.5 / 138.33 // old value: 5.7 distance: -1.5 //old ish?: 5.4
    ...
    /* PID */
    val kPivotProfileContraints: TrapezoidProfile.Constraints = TrapezoidProfile.Constraints(16.0, 16.0)
    ...
    val motorConfigs: TalonFXConfiguration = TalonFXConfiguration()
        .withSlot0(
            Slot0Configs()
                .withKS(0.0)
                .withKV(0.05)
