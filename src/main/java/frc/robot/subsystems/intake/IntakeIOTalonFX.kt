...
class IntakeIOTalonFX : IntakeIO {
  ...
  val motionMagicIntakeRequest: MotionMagicVelocityVoltage =
  ...
  val motionMagicPassthroughRequest: MotionMagicVelocityVoltage =
      MotionMagicVelocityVoltage(0.0).withSlot(0)
  ...
  private val passthroughMotorReferenceSlope: StatusSignal<Double> =
      passthroughMotor.closedLoopReferenceSlope
