...
object IntakeConstants {
    ...
    @JvmField
    var kPassthroughMotorID: Int = 35

    @JvmField
    var updateFrequency: Double = 50.0
    @JvmField
    var kIntakeMotionMagic: Boolean = false
    @JvmField
    var kPassthroughMotionMagic: Boolean = false

    @JvmField
    val intakeMotorConfig: TalonFXConfiguration = TalonFXConfiguration()
    ...
    @JvmField
    val passthroughMotorConfig: TalonFXConfiguration = TalonFXConfiguration()
