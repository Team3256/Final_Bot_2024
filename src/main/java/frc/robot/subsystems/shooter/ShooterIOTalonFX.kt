...
class ShooterIOTalonFX : ShooterIO {
    ...
    private val shooterMotorReferenceSlope: StatusSignal<Double> = shooterMotor.closedLoopReferenceSlope
    ...
    val motionMagicRequestFollower: MotionMagicVelocityVoltage = MotionMagicVelocityVoltage(0.0).withSlot(0)
    ...
    private val shooterMotorFollowerStatorCurrent: StatusSignal<Double> = shooterMotorFollower.statorCurrent
    private val shooterMotorFollowerSupplyCurrent: StatusSignal<Double> = shooterMotorFollower.supplyCurrent
    private val shooterMotorFollowerTemperature: StatusSignal<Double> = shooterMotorFollower.deviceTemp
    private val shooterMotorFollowerReferenceSlope: StatusSignal<Double> = shooterMotorFollower.closedLoopReferenceSlope
    ...
    init {
        ...
        PhoenixUtil.checkErrorAndRetry { shooterMotorFollower.configurator.refresh(motorConfigFollower) }
    ...
    override fun updateInputs(inputs: ShooterIOInputs) {
        ...
        inputs.shooterMotorFollowerReferenceSlope =
            shooterMotorFollowerReferenceSlope.valueAsDouble
    }
