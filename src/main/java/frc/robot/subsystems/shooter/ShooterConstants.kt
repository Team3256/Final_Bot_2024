...
object ShooterConstants {
    ...
    /* CAN */
    @JvmField
    var kShooterMotorID: Int = 11
    @JvmField
    var kShooterMotorFollowerID: Int = 23

    /* PID */ // Shooter
    var motorOutputConfigs: MotorOutputConfigs = MotorOutputConfigs()
        .withNeutralMode(NeutralModeValue.Brake)
        .withInverted(InvertedValue.Clockwise_Positive)
    @JvmField
    var motorConfigs: TalonFXConfiguration = TalonFXConfiguration()
        .withSlot0(
            Slot0Configs()
                .withKS(0.0)
    ...
    @JvmField
    var followerMotorConfigs: TalonFXConfiguration = motorConfigs.withMotorOutput(
    ...
    @JvmField
    var kShooterSubwooferRPS: Double = 60.0
    @JvmField
    var kShooterFollowerSubwooferRPS: Double = 70.0

    @JvmField
    var kShooterAmpRPS: Double = 22.5 // BEFORE: 1200/60
    @JvmField
    var kShooterFollowerAmpRPS: Double = 22.5
