...
class CTREConfigs {
  @JvmField var swerveAngleFXConfig: TalonFXConfiguration = TalonFXConfiguration()
  @JvmField var swerveDriveFXConfig: TalonFXConfiguration = TalonFXConfiguration()
  @JvmField var swerveCANcoderConfig: CANcoderConfiguration = CANcoderConfiguration()
  ...
  init {
    ...
    swerveAngleFXConfig.CurrentLimits.SupplyCurrentLimit =
        SwerveConstants.angleCurrentLimit.toDouble()
    ...
    swerveDriveFXConfig.CurrentLimits.SupplyCurrentLimit =
        SwerveConstants.driveCurrentLimit.toDouble()
